...
namespace EntryPoint
{
  ...
  public static class Program
  {
    ...
    private static IEnumerable<Vector2> SortSpecialBuildingsByDistance(Vector2 house, IEnumerable<Vector2> specialBuildings)
    {
            ...
            //get the size of the list of special buildings
            int max = specialBuildings.Count();

            //Return the sorted list to the program to be executed in the game
            return SortMerge(specialBuildings.ToArray(), house, 0, max - 1);
            
    }
    
    private static Vector2[] SortMerge(Vector2[] specialBuildings, Vector2 house, int left, int right)
    {
        int mid; 
        ...
        if (left < right)
        {
            ...
            MainMerge(specialBuildings, house, left, (mid + 1), right);
        }
        return specialBuildings;
    }
    
    private static void MainMerge(Vector2[] specialBuildings, Vector2 house, int left, int mid, int right)
    {
        ...
        {
            if (Vector2.Distance(specialBuildings[left], house) <= Vector2.Distance(specialBuildings[mid], house))
